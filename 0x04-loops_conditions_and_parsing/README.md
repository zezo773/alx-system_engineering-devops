...
![Bash Scripting Loops and Conditions](https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRLF8sSIcUeJopfZYflOSgJBkksEA-Q_YAcHw&s)
## Technologies
...
| `5-4_bad_luck_8_is_your_chance` | Loops from 1 to 10 and displays `Holberton School`, except for 4th and 8th iteration which displays `bad luck` and `good luck`, respectively For the most curious:
